...
import { LayoutDashboard, Package, ShoppingBag, User, LogOut, Menu, Home, Star } from 'lucide-react'
    ...
    <div className={`flex flex-col h-full ${mobile ? 'p-4' : 'p-5'}`}>
      ...
      >
        ...
        <div>
          ...
          <p className="text-[10px] text-[var(--text-muted)] -mt-0.5">Seller Portal</p>
        </div>
      </button>
      ...
      <div className="border-t border-[var(--border)] pt-4 mt-4 space-y-1">
        ...
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[var(--text-muted)] truncate">{user?.shopName || 'My Store'}</p>
          </div>
        </div>
